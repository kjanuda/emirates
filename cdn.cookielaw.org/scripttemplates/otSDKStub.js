var OneTrustStub = (t => {
    var e, a, o, r, i, l = new function() {
        ...
        s = ((i = e = e || {})[i.Days = 1] = "Days", i[i.Weeks = 7] = "Weeks", i[i.Months = 30] = "Months", i[i.Years = 365] = "Years", (i = y = y || {}).GDPR = "GDPR", i.CCPA = "CCPA", i.IAB2 = "IAB2", i.IAB2V2 = "IAB2V2", i.GENERIC = "GENERIC", i.LGPD = "LGPD", i.GENERIC_PROMPT = "GENERIC_PROMPT", i.CPRA = "CPRA", i.CDPA = "CDPA", i.DELAWARE = "DELAWARE", i.IOWA = "IOWA", i.NEBRASKA = "NEBRASKA", i.USNATIONAL = "USNATIONAL", i.CUSTOM = "CUSTOM", i.FLORIDA = "FLORIDA", i.COLORADO = "COLORADO", i.CONNECTICUT = "CTDPA", i.MONTANA = "MONTANA", i.TEXAS = "TEXAS", i.OREGON = "OREGON", i.TENNESSEE = "TENNESSEE", i.UCPA = "UCPA", y.CPRA, y.CDPA, y.COLORADO, y.OREGON, y.CONNECTICUT, y.FLORIDA, y.MONTANA, y.TEXAS, y.DELAWARE, y.IOWA, y.NEBRASKA, y.TENNESSEE, y.UCPA, (i = A = A || {}).Name = "OTGPPConsent", i[i.ChunkSize = 4e3] = "ChunkSize", i.ChunkCountParam = "GPPCookiesCount", (y = a = a || {}).CPRA = "usca", y.CCPA = "usca", y.CDPA = "usva", y.OREGON = "usor", y.USNATIONAL = "usnat", y.COLORADO = "usco", y.FLORIDA = "usfl", y.CTDPA = "usct", y.MONTANA = "usmt", y.TEXAS = "ustx", y.DELAWARE = "usde", y.IOWA = "usia", y.NEBRASKA = "usne", y.TENNESSEE = "ustn", y.UCPA = "usut", y.IAB2V2 = "tcfeuv2", (i = o = o || {})[i.CPRA = 8] = "CPRA", i[i.CCPA = 8] = "CCPA", i[i.CDPA = 9] = "CDPA", i[i.USOR = 15] = "USOR", i[i.USNATIONAL = 7] = "USNATIONAL", i[i.COLORADO = 10] = "COLORADO", i[i.FLORIDA = 13] = "FLORIDA", i[i.MONTANA = 14] = "MONTANA", i[i.TEXAS = 16] = "TEXAS", i[i.DELAWARE = 17] = "DELAWARE", i[i.IOWA = 18] = "IOWA", i[i.NEBRASKA = 19] = "NEBRASKA", i[i.TENNESSEE = 22] = "TENNESSEE", i[i.UCPA = 11] = "UCPA", i[i.CTDPA = 12] = "CTDPA", i[i.IAB2V2 = 2] = "IAB2V2", "geo"),
        u = "otpreview",
        p = (A.Name, "PRODUCTION"),
        n = ((y = {})[e.Days] = "PCenterVendorListLifespanDay", y[e.Weeks] = "LfSpnWk", y[e.Months] = "PCenterVendorListLifespanMonth", y[e.Years] = "LfSpnYr", c.prototype.camelize = function(t) {
    ...
    f.prototype.initConsentSDK = function() {
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202501.2.0")
    };
    var A = f;
    ...
    var y = new A;
    return t.OtSDKStub = A, t.otSdkStub = y, t
})({});